...
namespace YetAnotherUnityMcp.Editor.WebSocket
{
    ...
    public class MCPWebSocketServer
    {
        ...
        /// </summary>
        private void HandleClientConnected(WebSocketConnection connection)
        {
        ...
        /// </summary>
        private void HandleClientDisconnected(WebSocketConnection connection)
        {
            string clientId = connection.Id;
        ...
        /// </summary>
        private void HandleMessageReceived(string message, WebSocketConnection connection)
        {
            string clientId = connection.Id;
            
            try
            {
                // We'll let client message logging be handled by the WebSocketClientMessage.Process
